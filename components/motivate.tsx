    ...
    <Element name='motivate' role={'contentinfo'} className={styles.container}>
      ...
      <div className={styles.flex_container}>
        <div className={styles.text_container}>
          ...
          <p className={styles.text}>
            Por otro lado, Argentina cuenta con muchos destinos turísticos como lo son el obelisco, la flor metálica, el planetario, entre muchos otros y además de esto, su gente es bastante amable, por lo que encontrarás gente hermosa para conocer y lugares llamativos para decubrir.
          </p>
